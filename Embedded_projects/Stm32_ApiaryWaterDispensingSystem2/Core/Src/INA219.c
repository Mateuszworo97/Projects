...
void INA219_setCalibration_32V_1A(INA219_t *ina219,ina219_calibration *ina219calibration)
{
	...
	ina219calibration->ina219_calibrationValue = 10240;
	ina219calibration->ina219_currentDivider_mA = 25;    // Current LSB = 40uA per bit (1000/40 = 25)
	ina219calibration->ina219_powerMultiplier_mW = 0.8f; // Power LSB = 800uW per bit
...
void INA219_setCalibration_16V_400mA(INA219_t *ina219,ina219_calibration *ina219calibration)
{
	...
	ina219calibration->ina219_calibrationValue = 8192;
	ina219calibration->ina219_currentDivider_mA = 20;    // Current LSB = 50uA per bit (1000/50 = 20)
	ina219calibration->ina219_powerMultiplier_mW = 1.0f; // Power LSB = 1mW per bit
